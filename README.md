...
Since I cannot release the official Minecraft code, the code provided includes only most of the complete client code.
This is not the official repository and will only be updated after new version releases.
The code was released starting from commit `012f9b2`; therefore, in previous releases, the code remains the same as in `012f9b2`.
