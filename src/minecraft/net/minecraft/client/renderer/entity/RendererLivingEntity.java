        ...
        else
        {
            ...
            if (flag1)
            {
            	...
            	if (hitColorMod.isEnabled()) {
            		red = hitColorMod.getColorOption("hitColor").getColor().getRed();
            		green = hitColorMod.getColorOption("hitColor").getColor().getGreen();
            		blue = hitColorMod.getColorOption("hitColor").getColor().getBlue();
                	alpha = hitColorMod.getColorOption("hitColor").getColor().getAlpha();
                	
            		if (hitColorMod.getColorOption("hitColor").getColor().isChromaToggled()) {
