...
public class CPSDisplay extends ModDraggable {        
	...
	@Override
	public int getWidth() {
		return options.getBooleanOption("showBackground").isToggled() ? 53 : font.getStringWidth(options.getBracketsOption("brackets").wrap("0" + (options.getBooleanOption("showRightCPS").isToggled() ? " ⎟ 0" : "") + " CPS"));
	}
