...
public class GuiArmorStatus extends GuiMod {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.writeOptionText("Equipped Item", mod.isShowPercentageToggled() ? 4 : 5);
        this.writeOptionText("Damage Overlays", mod.isShowPercentageToggled() ? 5 : 6);
    }
    ...
    public void initGui() {
		...
		this.buttonList.add(this.createGuiCheckBox(6, mod.isEquippedItemToggled(), mod.isShowPercentageToggled() ? 4 : 5));
		this.buttonList.add(this.createGuiCheckBox(7, mod.isDamageOverlaysToggled(), mod.isShowPercentageToggled() ? 5 : 6));
    }
}
