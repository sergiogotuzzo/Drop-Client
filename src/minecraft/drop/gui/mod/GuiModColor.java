...
public class GuiModColor extends GuiMod {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawScaledText(subtitle, (this.width - 350) / 2 + 15, (this.height - 250) / 2 + 30 + 15 * 0 + 15 - 5, 1.3D, ColorManager.fromRGB(color.getRGB(), color.isChromaToggled()).setAlpha(255).getRGB(), true, color.isChromaToggled());
