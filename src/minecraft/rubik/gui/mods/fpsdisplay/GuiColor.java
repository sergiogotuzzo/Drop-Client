package rubik.gui.mods.fpsdisplay;
...
public class GuiColor extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("FPS Display Mod Color", new Object[0]), this.width / 2, 40, 0xFFFFFFFF);
