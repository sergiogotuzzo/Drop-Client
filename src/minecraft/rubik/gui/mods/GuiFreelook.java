...
public class GuiFreelook extends GuiScreen {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 + 2, this.height / 4 + 24 + i, 98, 20, I18n.format("Mode: " + (mod.isReturnOnReleaseEnabled() ? "Key Held" : "Toggle"), new Object[0])));
