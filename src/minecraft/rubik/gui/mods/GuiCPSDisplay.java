...
public class GuiCPSDisplay extends GuiScreen {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 + 2, this.height / 4 + 24 + i, 98, 20, I18n.format((mod.isBackgroundEnabled() ? EnumChatFormatting.GREEN : EnumChatFormatting.RED) + "Show Background", new Object[0])));
        ...
        this.buttonList.add(new GuiButton(5, this.width / 2 - 100 + 50, this.height / 4 + 72 + i, 98, 20, I18n.format((mod.isRightEnabled() ? EnumChatFormatting.GREEN : EnumChatFormatting.RED) + "Show Right CPS", new Object[0])));
