...
public class GuiBlockOverlay extends GuiRubikClientScreen {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 1:
                ...
                break;
            case 2:
            	mc.displayGuiScreen(new GuiBlockOverlayOutline(this));
            	break;
            case 3:
            	mc.displayGuiScreen(new GuiBlockOverlayOverlay(this));
            	break;
        }
    }
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 + j, this.height / 6 + i + 48, 150, 20, "Outline"));
        this.buttonList.add(new GuiButton(3, this.width / 2 + j + 160, this.height / 6 + i + 48, 150, 20, "Overlay"));
