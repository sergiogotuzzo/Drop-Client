...
public class GuiChat extends GuiScreen {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100, this.height / 4 + 48 + i, I18n.format((mod.isTransparentBackgroundEnabled() ? EnumChatFormatting.GREEN : EnumChatFormatting.RED) + "Transparent Background", new Object[0])));
