...
public class GuiChat extends GuiRubikClientScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, "Chat Settings", this.width / 2, 30, 0xFFFFFFFF);
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(3, this.width / 2 + j, this.height / 6 + i + 48, 150, 20, "Transparent Background: " + (mod.isTransparentBackgroundEnabled() ? "ON" : "OFF")));
