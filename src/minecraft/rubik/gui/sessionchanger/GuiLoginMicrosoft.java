...
public class GuiLoginMicrosoft extends GuiRubikClientScreen {
    ...
    public GuiLoginMicrosoft(GuiScreen previousGuiScreen) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, "Login with a Microsoft account", this.width / 2, 40, Color.WHITE.getRGB());
    ...
    protected void actionPerformed(GuiButton button) {
    	switch (button.id) {
    		case 0:
    			...
    			break;
    		case 1:
    			if (SessionChanger.getInstance().setUserMicrosoft(this.textFieldEmail.getText(), this.textFieldPassword.getText())) {
