...
public class GuiPingDisplay extends GuiDropClientScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawScaledText("Ping Display", (this.width - 300) / 2 + 15, (this.height - 200) / 2 + 15, 2.0D, 0xFFFFFFFF, false, false);
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiText(4, (this.width - 300) / 2 + 15, (this.height - 200) / 2 + 30 + 15 * 3 + 15, "Text Color"));
