...
public class GuiBlockOverlay extends GuiDropClientScreen {
	...
	private GuiDropClientSlider sliderOutlineWidth;
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButtonText(2, (this.width - 300) / 2 + 15, (this.height - 200) / 2 + 30 + 15 * 1 + 15, "Outline Color"));
    	this.buttonList.add(sliderOutlineWidth = new GuiDropClientSlider(3, (this.width - 300) / 2 + 100, (this.height - 200) / 2 + 30 + 15 * 2 + 15 + 1, 100, 5, 0, 5, mod.getOutlineWidth()));
    	this.buttonList.add(new GuiButtonToggled(4, mod.isOverlayEnabled(), (this.width + 300) / 2 - 20 - 15, (this.height - 200) / 2 + 30 + 15 * 3 + 15 - 2));
        this.buttonList.add(new GuiButtonText(5, (this.width - 300) / 2 + 15, (this.height - 200) / 2 + 30 + 15 * 4 + 15, "Overlay Color"));
