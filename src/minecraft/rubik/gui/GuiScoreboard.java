...
public class GuiScoreboard extends GuiDropClientScreen {
	...
	private GuiDropClientSlider sliderBackgroundOpacity;
    ...
    public void initGui() {
    	...
    	this.buttonList.add(sliderBackgroundOpacity = new GuiDropClientSlider(3, (this.width - 300) / 2 + 140, (this.height - 200) / 2 + 30 + 15 * 2 + 15 + 1, 100, 5, 0, 127, mod.getBackgroundOpacity()));
