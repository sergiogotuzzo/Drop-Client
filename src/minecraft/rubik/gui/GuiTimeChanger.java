...
public class GuiTimeChanger extends GuiDropClientScreen {
	...
	private GuiDropClientSlider sliderTime;
    ...
    public void initGui() {
    	...
    	this.buttonList.add(sliderTime = new GuiDropClientSlider(1, (this.width - 300) / 2 + 100, (this.height - 200) / 2 + 30 + 15 * 0 + 15 + 1, 100, 5, 0, 1, mod.getTime()));
