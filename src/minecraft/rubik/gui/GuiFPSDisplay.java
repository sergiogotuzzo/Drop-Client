...
public class GuiFPSDisplay extends GuiDropClientScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawScaledText("FPS Display", (this.width - 300) / 2 + 15, (this.height - 200) / 2 + 15, 2.0D, 0xFFFFFFFF, false, false);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 3:
            	...
            	break;
            case 4:
            	mc.displayGuiScreen(new GuiModDraggableTextColor(this, mod, "FPS Display"));
            	break;
        }
    }
