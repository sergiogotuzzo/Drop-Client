...
public class GuiDropClientSlider extends GuiButton {
    public boolean isMouseDown;
	private final float min;
	private final float max;
	private float sliderPosition;
	
	public GuiDropClientSlider(int buttonId, int x, int y, int widthIn, int heightIn, float min, float max, float defaultValue) {
