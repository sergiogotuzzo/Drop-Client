...
public class Clock extends ModDraggable {
	...
	public void render(ScreenPosition pos) {
		...
		drawCenteredText(getClockText(), pos.getAbsoluteX(), pos.getAbsoluteY(), textColor.getRGB(), textShadow, textChroma);
	}
	...
	private String getClockText() {
		...
		return showBackground ? formattedTime : "[" + formattedTime + "]";
	}
